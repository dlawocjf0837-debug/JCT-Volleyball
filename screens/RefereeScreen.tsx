        ...
        if (!team) {
            return (
                <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-700 text-center h-full flex items-center justify-center min-h-[200px]">
                    <p className="text-slate-400">{teamLabel}을 선택해주세요.</p>
                </div>
            );
        }
        ...
        <div className="w-full max-w-5xl mx-auto flex flex-col gap-6 flex-grow animate-fade-in">
            ...
            <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-700 p-6 rounded-lg shadow-2xl space-y-4">
                <div className="flex justify-between items-center">
                    <h2 className="text-2xl font-bold text-slate-300">경기 팀 선택</h2>
                ...
                <div className="space-y-2">
                    <label htmlFor="class-select-referee" className="block text-sm font-bold text-slate-300">1. 반 선택</label>
                    <select
                ...
                {selectedClass ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 animate-fade-in">
                        <div>
                            ...
                            <select
                                ...
                                aria-label="A팀 선택"
                            >
                                <option value="">-- A팀을 선택해주세요 --</option>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                aria-label="B팀 선택"
                            >
                                <option value="">-- B팀을 선택해주세요 --</option>
                                {filteredTeams.map(team => (
                    ...
                    <div className="text-center p-4 text-slate-400 bg-slate-800/30 rounded-lg">
                        <p>팀을 선택하려면 먼저 반을 선택해주세요.</p>
                    </div>
                )}
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-grow">
                <TeamRoster team={selectedTeamA} teamLabel="A팀" color="#38bdf8" />
                <TeamRoster team={selectedTeamB} teamLabel="B팀" color="#f87171" />
            </div>
