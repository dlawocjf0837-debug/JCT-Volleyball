    ...
    return (
        <>
            ...
            >
                ...
                >
                    <h2 className="text-2xl font-bold text-[#00A3FF] mb-4">팀 프로필 카드</h2>
                    ...
                    <div className="bg-slate-800 p-6 rounded-lg w-full max-w-md flex flex-col" style={{ borderColor: teamColor, borderStyle: 'solid', borderWidth: '2px' }}>
                        ...
                        <div className="flex-grow mt-4">
                            <h4 className="font-bold text-lg text-slate-300 mb-2">선수 명단</h4>
                    ...
                    <div className="flex justify-center gap-4 mt-6 w-full max-w-md">
                        <button onClick={onClose} className="bg-slate-600 hover:bg-slate-500 text-white font-bold py-2 px-6 rounded-lg">닫기</button>
                    </div>
                </div>
            </div>
            {selectedPlayer && (
